...
(function (global, factory) {
	...
	class OBB {
		...
		setFromCenterAndAxes(center, axisX, axisY, axisZ) {
			...
			this.rotation.set(_vec3_1$5.x, _vec3_2$1.x, _vec3_3$1.x, _vec3_1$5.y, _vec3_2$1.y, _vec3_3$1.y, _vec3_1$5.z, _vec3_2$1.z, _vec3_3$1.z);
	...
	class TileBoundingVolume {
		...
		setOBBData(data, transform) {
			...
			obb.setFromCenterAndAxes(_vec3_4.set(data[0], data[1], data[2]), _vec3_1$3.set(data[3], data[4], data[5]), _vec3_2.set(data[6], data[7], data[8]), _vec3_3.set(data[9], data[10], data[11])).applyMatrix4(transform);
			obb.updateCache();
			this.obb = obb;
		}
...
`);
	...
	class Tiles3D extends t3d.Object3D {
		...
		preprocessTileSet(json, url, parent = null) {
			...
			traverseSet(json.root, (node, parent) => preprocessTile(this.ellipsoid, node, parent, basePath), null, parent, parent ? parent.__depth : 0);
		}
		loadRootTileSet() {
			// transform the url
